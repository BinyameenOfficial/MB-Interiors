...
public class ProductSpecficationAdapter extends RecyclerView.Adapter<ProductSpecficationAdapter.ViewHolder> {

    private List<ProductSpecificationModel> productSpecificationModelList;

    public ProductSpecficationAdapter(List<ProductSpecificationModel> productSpecificationModelList) {
    ...
    @NonNull
    @Override
    public ProductSpecficationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        switch (viewType){
    ...
    @Override
    public void onBindViewHolder(@NonNull ProductSpecficationAdapter.ViewHolder viewHolder, int position) {
        switch (productSpecificationModelList.get(position).getType()){
            case ProductSpecificationModel.SPECIFICATION_TITLE:
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private  void setTitle(@NonNull String titleText){
